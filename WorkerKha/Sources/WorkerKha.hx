...
class WorkerKha {
	...
	function onMessage(message: Dynamic): Void {
		...
		case 'compilePipeline':
			...
			pipe.state.stencilMode =state.stencilMode;
			pipe.state.stencilBothPass = (state.stencilBothPass);
			pipe.state.stencilDepthFail = (state.stencilDepthFail);
			pipe.state.stencilFail = (state.stencilFail);
