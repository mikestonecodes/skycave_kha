...
Main.render = function(framebuffers) {
...
Main.setFullWindowCanvas = function() {
	...
	var resize = function() {
		var ewidth = window.innerWidth * window.devicePixelRatio | 0;
		var eheight = window.innerHeight * window.devicePixelRatio | 0;
		var zoom = Math.min(ewidth / 600,eheight / 600);
		zoom = zoom | 0;
		if(zoom == 0) {
			zoom = 1;
		}
		canvas.width = Math.ceil(5);
		canvas.height = Math.ceil(5);
		canvas.style.width = "100%";
		canvas.style.height = "100%";
		haxe_Log.trace(zoom,{ fileName : "Main.hx", lineNumber : 62, className : "Main", methodName : "setFullWindowCanvas"});
	};
...
Main.main = function() {
	...
	kha_System.start(new kha_SystemOptions("Project",1024,768,null,null),function(_) {
		kha_Assets.loadEverything(function() {
			Main.ui = new zui_Zui({ font : kha_Assets.fonts.DroidSans});
...
Main.itemList = ["Item 1","Item 2","Item 3"];
