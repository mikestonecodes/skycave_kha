...
var kha__$Assets_ImageList = $hxClasses["kha._Assets.ImageList"] = function() {
	...
	this.kodeDescription = { name : "kode", original_height : 280, file_sizes : [1], original_width : 280, files : ["kode.png"], type : "image"};
	this.kodeName = "kode";
	this.kode = null;
...
var kha__$Assets_FontList = $hxClasses["kha._Assets.FontList"] = function() {
	...
	this.DroidSansDescription = { name : "DroidSans", file_sizes : [1], files : ["DroidSans.ttf"], type : "font"};
